...
if ($typeid == 1 && Copyright)
{
	...
	$resultc = $lang->hk_cn_array($gameInfo->OpenNumberCounta ($mid, 4, 0));
	$resultd = $gameInfo->OpenNumberCounta (null, 5, 1);
	$resulte = $lang->hk_cn_array($gameInfo->OpenNumberCounta (null, 6, 1));
	$resultf = $lang->hk_cn_array($gameInfo->OpenNumberCounta (null, 2, 2));
