...
if ($typeId == "sumball_s")
{
	...
	$row_4 = $lang->hk_cn_array(sum_str_s_nc ($result, $href, 25, FALSE, 1));	//1-8號球-單雙
	$row_5 = sum_str_s_nc ($result, $href, 25, FALSE, 5, NULL, 0);	//1-8號球-尾數大小
	$row_6 = $lang->hk_cn_array(sum_str_s_nc ($result, $href, 25, FALSE, 7, NULL, 0));	//1-8號球-合數單雙
	$row_7 = sum_str_s_nc ($result, $href, 25, FALSE, 8);	//1-8號球-方位
	$row_8 = $lang->hk_cn_array(sum_str_s_nc ($result, $href, 25, FALSE, 9));	//1-8號球-中發白
	$row_9 = sum_str_s_nc ($result, $href, 25, FALSE, FALSE, 2, 0); 	//總和大小
	$row_10 = $lang->hk_cn_array(sum_str_s_nc ($result, $href, 25, FALSE, FALSE, 4, 0));	//總和單雙
