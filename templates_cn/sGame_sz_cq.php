...
<table class="ths" border="0" cellpadding="0" cellspacing="0" style="margin-top:0px">
    <tr height="24">
        <td class="bolds wanfa">重庆时时彩 <span style="color:#0033FF; font-weight:bold; margin-left:10px;" id="tys">整合</span></td>
        <td align="left" class="bolds" style="color:#FF0000">
        	<div id="row1" style="FONT-FAMILY: Arial; color: red;"> <span>今日输赢：</span></div>
